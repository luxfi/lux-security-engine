const rules = [
    ...
    },
    {
        ...
        valueTooltip: "Trust value refers to the total token approved and exposed to this contract. A low trust value indicates either risk or inactivity for 180 days.",
        valueDefine: {
            type: "int",
            min: 0,
            minIncluded: true,
