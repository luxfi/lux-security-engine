const rules = [
    {
        ...
        descriptions: {
            danger: "The recipient address is a token contract address, potentially causing funds loss",
        },
        valueDefine: {
            type: "boolean",
        },
    ...
    },
    {
        id: "1019",
        enable: true,
        valueDescription: "Recipient address is a contract address on a different chain",
        descriptions: {
            danger: "The recipient address is a contract address on a different chain, potentially causing funds loss",
        },
        valueDefine: {
            type: "boolean",
        },
    ...
    },
    {
        id: "1020",
        enable: true,
        valueDescription: "Recipient address is a deposit address on a CEX that does not support the current token",
        descriptions: {
            danger: "The recipient address is a deposit address on a CEX that does not support the current token. Please verify CEX support before transfer.",
        },
        valueDefine: {
            type: "boolean",
        },
    ...
    },
    {
        ...
        descriptions: {
            danger: "The recipient address is a non-deposit address from a CEX. Please ensure your deposit address is correct.",
        },
        valueDefine: {
            type: "boolean",
        },
    ...
    },
    {
        ...
        async getValue(ctx) {
            const { hasReceiverMnemonicInWallet, hasReceiverPrivateKeyInWallet } = (ctx.send || ctx.sendNFT);
    ...
    },
    {
        id: "1143",
        enable: true,
        valueDescription: "The recipient address is a scam address flagged by lux",
        descriptions: {
            danger: "The recipient address is a scam address flagged by lux",
        },
        valueDefine: {
            type: "boolean",
        },
